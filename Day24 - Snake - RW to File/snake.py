...
class Snake:
    ...
    def move(self):
        ...
        # Clear the list of the existing snakes, call create_snake method to start over.
        # Basically doing everything in the init.
        # While we still have control of the segments, need to banish them off-screen, or they'll persist there.
    def reset(self):
